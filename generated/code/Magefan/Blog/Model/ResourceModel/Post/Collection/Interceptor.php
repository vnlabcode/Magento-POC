...
class Interceptor extends \Magefan\Blog\Model\ResourceModel\Post\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addStoreFilter($store, $withAdmin = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoreFilter', func_get_args(), $pluginInfo) : parent::addStoreFilter($store, $withAdmin);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRecentFilter');
        return $pluginInfo ? $this->___callPlugins('addRecentFilter', func_get_args(), $pluginInfo) : parent::addRecentFilter();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPostsFilter');
        return $pluginInfo ? $this->___callPlugins('addPostsFilter', func_get_args(), $pluginInfo) : parent::addPostsFilter($postIds);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addArchiveFilter');
        return $pluginInfo ? $this->___callPlugins('addArchiveFilter', func_get_args(), $pluginInfo) : parent::addArchiveFilter($year, $month);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSearchFilter');
        return $pluginInfo ? $this->___callPlugins('addSearchFilter', func_get_args(), $pluginInfo) : parent::addSearchFilter($term);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTagFilter');
        return $pluginInfo ? $this->___callPlugins('addTagFilter', func_get_args(), $pluginInfo) : parent::addTagFilter($tag);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAuthorFilter');
        return $pluginInfo ? $this->___callPlugins('addAuthorFilter', func_get_args(), $pluginInfo) : parent::addAuthorFilter($author);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRelatedProductFilter');
        return $pluginInfo ? $this->___callPlugins('addRelatedProductFilter', func_get_args(), $pluginInfo) : parent::addRelatedProductFilter($product);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addActiveFilter');
        return $pluginInfo ? $this->___callPlugins('addActiveFilter', func_get_args(), $pluginInfo) : parent::addActiveFilter();
    }
