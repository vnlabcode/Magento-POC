...
class OrderExtension extends \Magento\Framework\Api\AbstractSimpleObject implements OrderExtensionInterface
{
    ...
    {
        return $this->_get('customer_shipping_date');
    }

    /**
     * @param string $customerShippingDate
     * @return $this
     */
    public function setCustomerShippingDate($customerShippingDate)
    {
        $this->setData('customer_shipping_date', $customerShippingDate);
        return $this;
    }
    ...
    {
        return $this->_get('customer_shipping_comments');
    }

    /**
     * @param string $customerShippingComments
     * @return $this
     */
    public function setCustomerShippingComments($customerShippingComments)
    {
        $this->setData('customer_shipping_comments', $customerShippingComments);
        return $this;
    }
}
