<?php
namespace Rokanthemes\SlideBanner\Model\Resource\Slide\Collection;

/**
 * Interceptor class for @see \Rokanthemes\SlideBanner\Model\Resource\Slide\Collection
 */
class Interceptor extends \Rokanthemes\SlideBanner\Model\Resource\Slide\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinSlider');
        return $pluginInfo ? $this->___callPlugins('joinSlider', func_get_args(), $pluginInfo) : parent::joinSlider();
    }
