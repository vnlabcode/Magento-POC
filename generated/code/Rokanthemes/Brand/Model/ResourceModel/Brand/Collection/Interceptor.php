<?php
namespace Rokanthemes\Brand\Model\ResourceModel\Brand\Collection;

/**
 * Interceptor class for @see \Rokanthemes\Brand\Model\ResourceModel\Brand\Collection
 */
class Interceptor extends \Rokanthemes\Brand\Model\ResourceModel\Brand\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'toOptionIdArray');
        return $pluginInfo ? $this->___callPlugins('toOptionIdArray', func_get_args(), $pluginInfo) : parent::toOptionIdArray();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFirstStoreFlag');
        return $pluginInfo ? $this->___callPlugins('setFirstStoreFlag', func_get_args(), $pluginInfo) : parent::setFirstStoreFlag($flag);
    }
