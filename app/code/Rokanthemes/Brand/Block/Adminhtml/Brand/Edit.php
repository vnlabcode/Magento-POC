 ...
 */
namespace Rokanthemes\Brand\Block\Adminhtml\Brand;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if ($this->_isAllowedAction('Rokanthemes_Brand::brand_delete')) {
    ...
    public function getHeaderText()
    {
        if ($this->_coreRegistry->registry('rokanthemes_brand')->getId()) {
            return __("Edit Brand '%1'", $this->escapeHtml($this->_coreRegistry->registry('rokanthemes_brand')->getName()));
        } else {
            return __('New Brand');
        }
    }
