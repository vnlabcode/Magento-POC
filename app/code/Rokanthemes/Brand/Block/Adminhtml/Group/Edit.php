 ...
 */
namespace Rokanthemes\Brand\Block\Adminhtml\Group;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct(){
    	...
    	if($this->_isAllowedAction('Rokanthemes_Brand::group_save')){
    	...
    	if ($this->_isAllowedAction('Rokanthemes_Brand::grou_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('rokanthemes_brand')->getId()) {
            return __("Edit Group '%1'", $this->escapeHtml($this->_coreRegistry->registry('rokanthemes_brand')->getName()));
        } else {
            return __('New Group');
        }
    }
