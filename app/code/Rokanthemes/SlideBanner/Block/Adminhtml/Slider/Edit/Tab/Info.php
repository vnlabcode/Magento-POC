       ...
       /** @var $model \Rokanthemes\SlideBanner\Model\Slide */
        ...
        $fieldset->addField(
            ...
            [
                ...
                'label'    => __('Identifier'),
                'required'     => true,
                'note' => 'Use the following code to insert the slider in your desired phtml or xml file: <br>$this->getLayout()->createBlock("Rokanthemes\SlideBanner\Block\Slider")->setslider_id("identifier")->toHtml();'
            ]
        );
        $fieldset->addField(
            'slider_status',
