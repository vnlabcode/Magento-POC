...
class ExportXml extends \Rokanthemes\Testimonial\Controller\Adminhtml\Testimo {
	/**
	...
	public function execute() {
		...
		$content = $this->_view->getLayout()->createBlock('Rokanthemes\Testimonial\Block\Adminhtml\Testimo\Grid')->getXml();
