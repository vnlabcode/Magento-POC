...
class Save extends \Rokanthemes\Testimonial\Controller\Adminhtml\Testimo {
	/**
	...
	public function execute() {
		if ($data = $this->getRequest()->getPostValue()) {
			...
			try {
				...
				$result = $uploader->save($mediaDirectory->getAbsolutePath(\Rokanthemes\Testimonial\Model\Testimo::BASE_MEDIA_PATH));
				$data['avatar'] = \Rokanthemes\Testimonial\Model\Testimo::BASE_MEDIA_PATH . $result['file'];
			} catch (\Exception $e) {
				if ($e->getCode() == 0) {
